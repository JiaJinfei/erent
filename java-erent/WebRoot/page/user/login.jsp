    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>农车快租</h1></div>
                
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input name="userUsername" type="text" class="input input-big" placeholder="登录账号" data-validate="required:请填写账号" />
                    ...
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input name="userPwd" type="password" class="input input-big" placeholder="登录密码" data-validate="required:请填写密码" />
