...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/employee/TypeServlet?m=add">  
      <div class="form-group">
        <div class="label">
          <label><span style="color:red;">*</span>类型名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="${machineType.typeName}" name="typeName" data-validate="required:请输入类型名称" maxlength="10" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="typeRemark" value="${machineType.typeRemark}" style="" maxlength="50"/>
          <div class="tips"></div>
        </div>
      </div>
